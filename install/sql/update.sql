...
-- UPDATE `melisv2`.`melis_ecom_order_status_trans` SET `ostt_status_name` = 'Not finalized' WHERE `melis_ecom_order_status_trans`.`ostt_id` = 11;
-- UPDATE `melisv2`.`melis_ecom_order_status_trans` SET `ostt_status_name` = 'Non finalisé' WHERE `melis_ecom_order_status_trans`.`ostt_id` = 12;
