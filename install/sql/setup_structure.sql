...
CREATE TABLE IF NOT EXISTS `melis_ecom_price` (
  ...
  `price_group_id` INT NOT NULL COMMENT 'Group of the price',
  ...
  INDEX `group_idx` (`price_group_id` ASC))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_doc_relations` (
  ...
  INDEX `fk_melis_ecom_doc_relations_melis_ecom_order1_idx` (`rdoc_order_id` ASC))
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_client` (
  ...
  INDEX `group_idx` (`cli_group_id` ASC))
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Data for table `melis_ecom_client_groups`
-- -----------------------------------------------------
START TRANSACTION;
