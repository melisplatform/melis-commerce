...
CREATE TABLE IF NOT EXISTS `melis_ecom_currency` (
  ...
  `cu_default` TINYINT(1) NULL DEFAULT 0 COMMENT ''Default currency'',
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `melis_ecom_currency` (`cur_id`, `cu_default`, `cur_name`, `cur_code`, `cur_symbol`, `cur_status`) VALUES (1, 0, ''EURO'', ''EUR'', ''€'', NULL);
INSERT INTO `melis_ecom_currency` (`cur_id`, `cu_default`, `cur_name`, `cur_code`, `cur_symbol`, `cur_status`) VALUES (2, 1, ''DOLLAR'', ''DOL'', ''$'', NULL);
INSERT INTO `melis_ecom_currency` (`cur_id`, `cu_default`, `cur_name`, `cur_code`, `cur_symbol`, `cur_status`) VALUES (3, 0, ''RENMINBI'', ''RMB'', ''¥'', NULL);
INSERT INTO `melis_ecom_currency` (`cur_id`, `cu_default`, `cur_name`, `cur_code`, `cur_symbol`, `cur_status`) VALUES (4, 0, ''POUND'', ''GBP'', ''£'', NULL);
INSERT INTO `melis_ecom_currency` (`cur_id`, `cu_default`, `cur_name`, `cur_code`, `cur_symbol`, `cur_status`) VALUES (5, 0, ''YEN'', ''JPY'', ''¥'', NULL);
INSERT INTO `melis_ecom_currency` (`cur_id`, `cu_default`, `cur_name`, `cur_code`, `cur_symbol`, `cur_status`) VALUES (6, 0, ''AUSTRALIAN DOLLAR'', ''AUD'', ''A$'', NULL);
