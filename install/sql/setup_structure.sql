...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `melis_ecom_lang` (`elang_id`, `elang_locale`, `elang_name`, `elang_status`) VALUES (1, 'en_EN', 'English', 0);
INSERT INTO `melis_ecom_lang` (`elang_id`, `elang_locale`, `elang_name`, `elang_status`) VALUES (2, 'fr_FR', 'Français', 1);
INSERT INTO `melis_ecom_lang` (`elang_id`, `elang_locale`, `elang_name`, `elang_status`) VALUES (3, 'de_DE', 'Deutsch', NULL);
INSERT INTO `melis_ecom_lang` (`elang_id`, `elang_locale`, `elang_name`, `elang_status`) VALUES (4, 'pt_PT', 'Português', NULL);
INSERT INTO `melis_ecom_lang` (`elang_id`, `elang_locale`, `elang_name`, `elang_status`) VALUES (5, 'it_IT', 'Italiano', NULL);
INSERT INTO `melis_ecom_lang` (`elang_id`, `elang_locale`, `elang_name`, `elang_status`) VALUES (6, 'es_ES', 'Español', NULL);
INSERT INTO `melis_ecom_lang` (`elang_id`, `elang_locale`, `elang_name`, `elang_status`) VALUES (7, 'ru_RU', 'русский (Russian)', NULL);
INSERT INTO `melis_ecom_lang` (`elang_id`, `elang_locale`, `elang_name`, `elang_status`) VALUES (8, 'zh', '中文 (Chinese)', NULL);
INSERT INTO `melis_ecom_lang` (`elang_id`, `elang_locale`, `elang_name`, `elang_status`) VALUES (9, 'ja_JP', '日本語 (Japanese)', NULL);
INSERT INTO `melis_ecom_lang` (`elang_id`, `elang_locale`, `elang_name`, `elang_status`) VALUES (10, 'ko_KR', '한국어/조선말 (Korean)', NULL);
INSERT INTO `melis_ecom_lang` (`elang_id`, `elang_locale`, `elang_name`, `elang_status`) VALUES (11, 'hi_IN', 'हिंदी (Hindi)', NULL);
