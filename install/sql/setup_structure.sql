...
CREATE TABLE IF NOT EXISTS `melis_ecom_category` (
  ...
  INDEX `father_idx` (`cat_father_cat_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_lang` (
  ...
  `elang_status` TINYINT(1) NULL DEFAULT 1 COMMENT '',
  `elang_flag` LONGTEXT NULL COMMENT '',
  PRIMARY KEY (`elang_id`)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_category_trans` (
  ...
  PRIMARY KEY (`catt_id`)  COMMENT '',
  INDEX `category_idx` (`catt_category_id` ASC)  COMMENT '',
  INDEX `lang_idx` (`catt_lang_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_currency` (
  ...
  `cur_status` TINYINT(1) NULL COMMENT '',
...
CREATE TABLE IF NOT EXISTS `melis_ecom_country` (
  ...
  `ctry_status` TINYINT(1) NULL COMMENT '',
  `ctry_flag` LONGTEXT NULL DEFAULT NULL COMMENT '',
  PRIMARY KEY (`ctry_id`)  COMMENT '',
  INDEX `currency_idx` (`ctry_currency_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_country_category` (
  ...
  PRIMARY KEY (`ccat_id`)  COMMENT '',
  INDEX `country_idx` (`ccat_country_id` ASC)  COMMENT '',
  INDEX `category_idx` (`ccat_category_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_variant` (
  ...
  PRIMARY KEY (`var_id`)  COMMENT '',
  INDEX `product_idx` (`var_prd_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_product_category` (
  ...
  PRIMARY KEY (`pcat_id`)  COMMENT '',
  INDEX `product_idx` (`pcat_prd_id` ASC)  COMMENT '',
  INDEX `category_idx` (`pcat_cat_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_product_text` (
  ...
  PRIMARY KEY (`ptxt_id`)  COMMENT '',
  INDEX `product_idx` (`ptxt_prd_id` ASC)  COMMENT '',
  INDEX `lang_idx` (`ptxt_lang_id` ASC)  COMMENT '',
  INDEX `type_idx` (`ptxt_type` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_variant_stock` (
  `stock_id` INT NOT NULL AUTO_INCREMENT COMMENT '',
...
CREATE TABLE IF NOT EXISTS `melis_ecom_price` (
  ...
  INDEX `product_idx` (`price_prd_id` ASC)  COMMENT '',
  INDEX `variant_idx` (`price_var_id` ASC)  COMMENT '',
  INDEX `country_idx` (`price_country_id` ASC)  COMMENT '',
  INDEX `cuurency_idx` (`price_currency` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_doc_type` (
  ...
  `dtype_parent_type_id` INT NULL DEFAULT 0 COMMENT '',
  PRIMARY KEY (`dtype_id`)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_document` (
  ...
  INDEX `type_idx` (`doc_type_id` ASC)  COMMENT '',
  INDEX `type2_idx` (`doc_subtype_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_doc_relations` (
  ...
  PRIMARY KEY (`rdoc_id`)  COMMENT '',
  INDEX `document_idx` (`rdoc_doc_id` ASC)  COMMENT '',
  INDEX `category_idx` (`rdoc_category_id` ASC)  COMMENT '',
  INDEX `product_idx` (`rdoc_product_id` ASC)  COMMENT '',
  INDEX `variant_idx` (`rdoc_variant_id` ASC)  COMMENT '',
  INDEX `country_idx` (`rdoc_country_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_attribute` (
  ...
  PRIMARY KEY (`attr_id`)  COMMENT '',
  INDEX `type_idx` (`attr_type_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_attribute_trans` (
  ...
  PRIMARY KEY (`atrans_id`)  COMMENT '',
  INDEX `attributeid_idx` (`atrans_attribute_id` ASC)  COMMENT '',
  INDEX `langid_idx` (`atrans_lang_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_attribute_value` (
  ...
  PRIMARY KEY (`atval_id`)  COMMENT '',
  INDEX `attributeid_idx` (`atval_attribute_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_attribute_value_trans` (
  ...
  PRIMARY KEY (`avt_id`)  COMMENT '',
  INDEX `attributevalueid_idx` (`av_attribute_value_id` ASC)  COMMENT '',
  INDEX `langid_idx` (`avt_lang_id` ASC)  COMMENT '')
ENGINE = InnoDB
COMMENT = 'This table stores the values of the attributes';
...
CREATE TABLE IF NOT EXISTS `melis_ecom_product_attribute` (
  ...
  PRIMARY KEY (`patt_id`)  COMMENT '',
  INDEX `product_idx` (`patt_product_id` ASC)  COMMENT '',
  INDEX `attribute_idx` (`patt_attribute_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_variant_attribute_value` (
  ...
  PRIMARY KEY (`vatv_id`)  COMMENT '',
  INDEX `variant_idx` (`vatv_variant_id` ASC)  COMMENT '',
  INDEX `attributevalue_idx` (`vatv_attribute_value_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_basket_anonymous` (
  ...
  PRIMARY KEY (`bano_id`)  COMMENT '',
  INDEX `variant_idx` (`bano_variant_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_client` (
  ...
  INDEX `country_idx` (`cli_country_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_basket_persistent` (
  ...
  PRIMARY KEY (`bper_id`)  COMMENT '',
  INDEX `variant_idx` (`bper_variant_id` ASC)  COMMENT '',
  INDEX `client_idx` (`bper_client_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_client_person` (
  ...
  PRIMARY KEY (`cper_id`)  COMMENT '',
  INDEX `client_idx` (`cper_client_id` ASC)  COMMENT '',
  INDEX `lang_idx` (`cper_lang_id` ASC)  COMMENT '',
  INDEX `civility_idx` (`cper_civility` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_client_company` (
  ...
  PRIMARY KEY (`ccomp_id`)  COMMENT '',
  INDEX `client_idx` (`ccomp_client_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_client_address` (
  ...
  PRIMARY KEY (`cadd_id`)  COMMENT '',
  INDEX `client_idx` (`cadd_client_id` ASC)  COMMENT '',
  INDEX `clientperson_idx` (`cadd_client_person` ASC)  COMMENT '',
  INDEX `civility_idx` (`cadd_civility` ASC)  COMMENT '',
  INDEX `addresstype_idx` (`cadd_type` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_order_status` (
  ...
  `osta_status` TINYINT(1) NULL DEFAULT 1 COMMENT '',
  PRIMARY KEY (`osta_id`)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_order` (
  ...
  PRIMARY KEY (`ord_id`)  COMMENT '',
  INDEX `status_idx` (`ord_status` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_order_status_trans` (
  ...
  PRIMARY KEY (`ostt_id`)  COMMENT '',
  INDEX `status_idx` (`ostt_status_id` ASC)  COMMENT '',
  INDEX `lang_idx` (`ostt_lang_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_order_basket` (
  ...
  PRIMARY KEY (`obas_id`)  COMMENT '',
  INDEX `order_idx` (`obas_order_id` ASC)  COMMENT '',
  INDEX `variant_idx` (`obas_variant_id` ASC)  COMMENT '',
  INDEX `currency_idx` (`obas_currency` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_order_address` (
  ...
  PRIMARY KEY (`oadd_id`)  COMMENT '',
  INDEX `civility_idx` (`oadd_civility` ASC)  COMMENT '',
  INDEX `order_idx` (`oadd_order_id` ASC)  COMMENT '',
  INDEX `type_idx` (`oadd_type` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_client_address_type_trans` (
  ...
  PRIMARY KEY (`catypt_id`)  COMMENT '',
  INDEX `type_idx` (`catypt_type_id` ASC)  COMMENT '',
  INDEX `lang_idx` (`catypt_lang_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_civility_trans` (
  ...
  PRIMARY KEY (`civt_id`)  COMMENT '',
  INDEX `lang_idx` (`civt_lang_id` ASC)  COMMENT '',
  INDEX `civility_idx` (`civt_civ_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_order_payment` (
  ...
  PRIMARY KEY (`opay_id`)  COMMENT '',
  INDEX `order_idx` (`opay_order_id` ASC)  COMMENT '',
  INDEX `cuurency_idx` (`opay_currency_id` ASC)  COMMENT '',
  INDEX `paymentype_idx` (`opay_payment_type_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_order_shipping` (
  `oship_id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `oship_order_id` INT NOT NULL COMMENT '',
  `oship_tracking_code` VARCHAR(100) NOT NULL COMMENT '',
  `oship_content` TEXT NOT NULL COMMENT '',
  `oship_date_sent` DATETIME NOT NULL COMMENT '',
  PRIMARY KEY (`oship_id`)  COMMENT '',
  INDEX `order_idx` (`oship_order_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_order_message` (
  ...
  PRIMARY KEY (`omsg_id`)  COMMENT '',
  INDEX `order_idx` (`omsg_order_id` ASC)  COMMENT '',
  INDEX `client_idx` (`omsg_client_id` ASC)  COMMENT '',
  INDEX `clientperson_idx` (`omsg_client_person_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_coupon_client` (
  ...
  PRIMARY KEY (`ccli_id`)  COMMENT '',
  INDEX `coupon_idx` (`ccli_coupon_id` ASC)  COMMENT '',
  INDEX `client_idx` (`ccli_client_id` ASC)  COMMENT '')
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `melis_ecom_seo` (
  ...
  PRIMARY KEY (`eseo_id`)  COMMENT '',
  INDEX `category_id_idx` (`eseo_category_id` ASC)  COMMENT '',
  INDEX `product_id_idx` (`eseo_product_id` ASC)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `melis_ecom_assoc_variants_type` (
  `avart_id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `avart_code` VARCHAR(45) NOT NULL COMMENT '',
  `avart_name` VARCHAR(50) NOT NULL COMMENT '',
  PRIMARY KEY (`avart_id`)  COMMENT '')
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `melis_ecom_assoc_variant` (
  `avar_id` INT NOT NULL AUTO_INCREMENT COMMENT '',
  `avar_one` INT NOT NULL COMMENT '',
  `avar_two` INT NOT NULL COMMENT '',
  `avar_type_id` INT NULL COMMENT '',
  PRIMARY KEY (`avar_id`)  COMMENT '',
  INDEX `var_id_idx` (`avar_one` ASC)  COMMENT '',
  INDEX `var_id_idx1` (`avar_two` ASC)  COMMENT '',
  INDEX `avart_id_idx` (`avar_type_id` ASC)  COMMENT '')
ENGINE = InnoDB;
