...
CREATE TABLE IF NOT EXISTS `melis_ecom_country` (
  ...
  `ctry_order` INT NOT NULL COMMENT 'Order for displaying of country',
...
CREATE TABLE IF NOT EXISTS `melis_ecom_order_status` (
  ...
  `osta_status` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '',
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `melis_ecom_lang` (`elang_id`, `elang_locale`, `elang_name`) VALUES (1, 'en_EN', 'English');
INSERT INTO `melis_ecom_lang` (`elang_id`, `elang_locale`, `elang_name`) VALUES (2, 'fr_FR', 'Français');
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `melis_ecom_currency` (`cur_id`, `cur_name`, `cur_code`, `cur_symbol`) VALUES (1, 'EURO', 'EUR', '€');
INSERT INTO `melis_ecom_currency` (`cur_id`, `cur_name`, `cur_code`, `cur_symbol`) VALUES (2, 'DOLLAR', 'DOL', '$');
INSERT INTO `melis_ecom_currency` (`cur_id`, `cur_name`, `cur_code`, `cur_symbol`) VALUES (3, 'RENMINBI', 'RMB', '¥');
INSERT INTO `melis_ecom_currency` (`cur_id`, `cur_name`, `cur_code`, `cur_symbol`) VALUES (4, 'POUND', 'GBP', '£');
INSERT INTO `melis_ecom_currency` (`cur_id`, `cur_name`, `cur_code`, `cur_symbol`) VALUES (5, 'YEN', 'JPY', '¥');
INSERT INTO `melis_ecom_currency` (`cur_id`, `cur_name`, `cur_code`, `cur_symbol`) VALUES (6, 'AUSTRALIAN DOLLAR', 'AUD', 'A$');
...
-- -----------------------------------------------------
START TRANSACTION;
INSERT INTO `melis_ecom_country` (`ctry_id`, `ctry_order`, `ctry_name`, `ctry_currency_id`) VALUES (1, 1, 'France', 1);
INSERT INTO `melis_ecom_country` (`ctry_id`, `ctry_order`, `ctry_name`, `ctry_currency_id`) VALUES (2, 2, 'USA', 2);
INSERT INTO `melis_ecom_country` (`ctry_id`, `ctry_order`, `ctry_name`, `ctry_currency_id`) VALUES (3, 3, 'China', 3);
INSERT INTO `melis_ecom_country` (`ctry_id`, `ctry_order`, `ctry_name`, `ctry_currency_id`) VALUES (4, 4, 'United Kingdom', 4);
INSERT INTO `melis_ecom_country` (`ctry_id`, `ctry_order`, `ctry_name`, `ctry_currency_id`) VALUES (5, 5, 'Germany', 1);
INSERT INTO `melis_ecom_country` (`ctry_id`, `ctry_order`, `ctry_name`, `ctry_currency_id`) VALUES (6, 6, 'Spain', 1);
INSERT INTO `melis_ecom_country` (`ctry_id`, `ctry_order`, `ctry_name`, `ctry_currency_id`) VALUES (7, 7, 'Italy', 1);
INSERT INTO `melis_ecom_country` (`ctry_id`, `ctry_order`, `ctry_name`, `ctry_currency_id`) VALUES (8, 8, 'Japan', DEFAULT);
INSERT INTO `melis_ecom_country` (`ctry_id`, `ctry_order`, `ctry_name`, `ctry_currency_id`) VALUES (9, 9, 'Australia', DEFAULT);
...
INSERT INTO `melis_ecom_order_status` (`osta_id`, `osta_color_code`, `osta_status`) VALUES (6, '#fc0935', 1);
...
INSERT INTO `melis_ecom_civility_trans` (`civt_id`, `civt_civ_id`, `civt_lang_id`, `civt_min_name`, `civt_max_name`) VALUES (3, 2, 1, 'Mme', 'Madam');
