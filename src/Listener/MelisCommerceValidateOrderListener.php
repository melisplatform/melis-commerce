...
class MelisCommerceValidateOrderListener extends MelisCoreGeneralListener implements ListenerAggregateInterface
{
        ...
        $callBackHandler = $sharedEvents->attach(
        	...
        	function($e){
	            ...
	            list($success, $errors, $datas) = $melisCoreDispatchService->dispatchPluginAction(
	                ...
	                'order-valid-data',
	                'MelisCommerce\Controller\MelisComOrder',
	                array_merge(array('action' => 'saveOrderData'), array('data' => $paramData))
	                );
