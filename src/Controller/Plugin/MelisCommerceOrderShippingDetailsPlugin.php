 ...
 * $view->addChild($pluginView, 'shippingDetails');
 * 
 * How to display in your controller's view:
 * echo $this->shippingDetails;
 * 
 * 
 */
class MelisCommerceOrderShippingDetailsPlugin extends MelisTemplatingPlugin
{
    public function __construct($updatesPluginConfig = array())
    {
        ...
        $this->pluginXmlDbKey = 'MelisCommerceOrderShippingDetailsPlugin';
    ...
    public function front()
    {
        ...
        $orderId = !empty($this->pluginFrontConfig['m_sd_order_id'])? $this->pluginFrontConfig['m_sd_order_id'] : null;
    ...
    public function loadDbXmlToPluginConfig()
    {
        ...
        if ($xml)
        {
            ...
            if (!empty($xml->m_sd_order_id))
            {
                $configValues['m_sd_order_id'] = (string)$xml->m_sd_order_id;
            }
        }
    ...
    public function savePluginConfigToXml($parameters)
    {
        ...
        if (!empty($parameters['m_sd_order_id']))
        {
            $xmlValueFormatted .= "\t\t" . '<m_sd_order_id><![CDATA[' . $parameters['m_sd_order_id'] . ']]></m_sd_order_id>';
        }
