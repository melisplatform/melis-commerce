...
class MelisComContactController extends MelisAbstractActionController
{
     ...
     */
    const MELIS_KEY = 'meliscommerce_contact_list_page';

    /** Actions partagées avec d'autres outils : une des clés suffit, '@login' = connexion seule. */
    const TOOL_KEY_MAP = [
        'fetchAllContact' => ['meliscommerce_contact_list_page', 'meliscommerce_clients_list_page'], // onglet contacts des Comptes
    ];
