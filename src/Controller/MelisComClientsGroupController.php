...
class MelisComClientsGroupController extends MelisAbstractActionController
{
     ...
     */
    const MELIS_KEY = 'meliscommerce_clients_group_tool_container';
    ...
    public function getClientsGroupListAction()
    {
        ...
        if($this->getRequest()->isPost()) {
            ...
            foreach($tableData as $key => $val){
                ...
                $tableData[$key]['cgroup_name'] = $val['cgroup_name'];//!empty($val['cgroup_name']) ? "<span class='d-none td-tooltip'>".$val['cgroup_name']."</span>".mb_strimwidth($val['cgroup_name'], 0, 70, '...') : null;
