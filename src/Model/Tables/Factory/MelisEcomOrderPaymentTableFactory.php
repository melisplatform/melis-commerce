...
class MelisEcomOrderPaymentTableFactory implements FactoryInterface
{

    public function createService(ServiceLocatorInterface $sl)
    {
        $hydratingResultSet = new HydratingResultSet(new ObjectProperty(), new MelisEcomOrderPayment());
        $tableGateway = new TableGateway('melis_ecom_order_payment', $sl->get('Zend\Db\Adapter\Adapter'), null, $hydratingResultSet);
        
        return new MelisEcomOrderPaymentTable($tableGateway);
    }
}