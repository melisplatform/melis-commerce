...
class MelisEcomClientAddressTableFactory implements FactoryInterface
{

    public function createService(ServiceLocatorInterface $sl)
    {
        $hydratingResultSet = new HydratingResultSet(new ObjectProperty(), new MelisEcomClientAddress());
        $tableGateway = new TableGateway('melis_ecom_client_address', $sl->get('Zend\Db\Adapter\Adapter'), null, $hydratingResultSet);
        
        return new MelisEcomClientAddressTable($tableGateway);
    }
}