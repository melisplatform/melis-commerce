...
class MelisEcomOrderMessageTableFactory implements FactoryInterface
{

    public function createService(ServiceLocatorInterface $sl)
    {
        $hydratingResultSet = new HydratingResultSet(new ObjectProperty(), new MelisEcomOrderMessage());
        $tableGateway = new TableGateway('melis_ecom_order_message', $sl->get('Zend\Db\Adapter\Adapter'), null, $hydratingResultSet);
        
        return new MelisEcomOrderMessageTable($tableGateway);
    }
}