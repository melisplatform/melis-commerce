...
class MelisEcomDocRelationsTableFactory implements FactoryInterface
{

    public function createService(ServiceLocatorInterface $sl)
    {
        $hydratingResultSet = new HydratingResultSet(new ObjectProperty(), new MelisEcomDocRelations());
        $tableGateway = new TableGateway('melis_ecom_doc_relations', $sl->get('Zend\Db\Adapter\Adapter'), null, $hydratingResultSet);
        
        return new MelisEcomDocRelationsTable($tableGateway);
    }
}