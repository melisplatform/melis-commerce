...
class MelisEcomVariantAttributeValueTableFactory implements FactoryInterface
{

    public function createService(ServiceLocatorInterface $sl)
    {
        $hydratingResultSet = new HydratingResultSet(new ObjectProperty(), new MelisEcomVariantAttributeValue());
        $tableGateway = new TableGateway('melis_ecom_variant_attribute_value', $sl->get('Zend\Db\Adapter\Adapter'), null, $hydratingResultSet);
        
        return new MelisEcomVariantAttributeValueTable($tableGateway);
    }
}