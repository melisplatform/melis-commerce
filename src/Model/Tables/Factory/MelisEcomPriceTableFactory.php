...
class MelisEcomPriceTableFactory implements FactoryInterface
{

    public function createService(ServiceLocatorInterface $sl)
    {
        $hydratingResultSet = new HydratingResultSet(new ObjectProperty(), new MelisEcomPrice());
        $tableGateway = new TableGateway('melis_ecom_price', $sl->get('Zend\Db\Adapter\Adapter'), null, $hydratingResultSet);
        
        return new MelisEcomPriceTable($tableGateway);
    }
}