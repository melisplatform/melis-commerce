...
class MelisEcomSeoTableFactory implements FactoryInterface
{

    public function createService(ServiceLocatorInterface $sl)
    {
        $hydratingResultSet = new HydratingResultSet(new ObjectProperty(), new MelisEcomSeo());
        $tableGateway = new TableGateway('melis_ecom_seo', $sl->get('Zend\Db\Adapter\Adapter'), null, $hydratingResultSet);
        
        return new MelisEcomSeoTable($tableGateway);
    }
}