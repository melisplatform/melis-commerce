...
class MelisEcomProductAttributeTableFactory implements FactoryInterface
{

    public function createService(ServiceLocatorInterface $sl)
    {
        $hydratingResultSet = new HydratingResultSet(new ObjectProperty(), new MelisEcomProductAttribute());
        $tableGateway = new TableGateway('melis_ecom_product_attribute', $sl->get('Zend\Db\Adapter\Adapter'), null, $hydratingResultSet);
        
        return new MelisEcomProductAttributeTable($tableGateway);
    }
}