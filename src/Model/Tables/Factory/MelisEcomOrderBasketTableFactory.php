...
class MelisEcomOrderBasketTableFactory implements FactoryInterface
{

    public function createService(ServiceLocatorInterface $sl)
    {
        $hydratingResultSet = new HydratingResultSet(new ObjectProperty(), new MelisEcomOrderBasket());
        $tableGateway = new TableGateway('melis_ecom_order_basket', $sl->get('Zend\Db\Adapter\Adapter'), null, $hydratingResultSet);
        
        return new MelisEcomOrderBasketTable($tableGateway);
    }
}