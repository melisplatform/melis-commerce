// qTip2 - http://qtip2.com Pretty powerful tooltips - @@vVERSION
// Fork: https://github.com/makifgokce/qTip2
// v3.0.4, Copyright (c) 2021 
        ...
        $.extend(self, {
            init: function() {
                ...
                $(document).on('keydown'+MODALSELECTOR, function(event) {
                    if(current && current.options.show.modal.escape && event.key === 27) {
                        current.hide(event);
                    }
                });
