...
export const DICT = mergeDict({
  fr: {
    ...
    pick_user: '— Choisir un utilisateur —', recip_search_ph: 'Rechercher un destinataire…', recip_no_result: 'Aucun utilisateur',
  ...
  en: {
    ...
    pick_user: '— Pick a user —', recip_search_ph: 'Search a recipient…', recip_no_result: 'No user',
