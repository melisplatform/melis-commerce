...
export const COMMON: Dict = {
  fr: {
    ...
    dr_custom: 'Plage personnalisée', dr_from: 'Du', dr_to: 'Au', dr_apply: 'Appliquer', cal_clear: 'Effacer',
  ...
  en: {
    ...
    dr_custom: 'Custom range', dr_from: 'From', dr_to: 'To', dr_apply: 'Apply', cal_clear: 'Clear',
